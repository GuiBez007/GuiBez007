...
Durante minha formação, participei de projetos, competições e eventos de tecnologia, incluindo **InterFATECs, RoboCode e EXPOTECH**.
...
Aplicação web desenvolvida para uma loja, explorando criação de interfaces e funcionalidades para uma experiência de compra.
...
Projeto voltado para leitura e manipulação de arquivos PDF através de uma aplicação web.
